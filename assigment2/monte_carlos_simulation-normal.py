...
if __name__ == "__main__":
    ...
    plt.title("Monte Carlo Estimation of Pi using normal random sampling")
    plt.legend()
    plt.figtext(
        0.5,
        0.1,
        "Monte Carlo simulation to compute the value of pi using repeated normal random sampling to estimate the probability of dart landing in a circle",
        fontsize=8,
